...
void myDisplay()
{
	...
	// Zatraži crtanje toka vrhova duljine 6 pri čemu se vrhove interpretira kao trokute, a tok nastaje
	// tako da redom dohvaćamo vrhove na zadanim indeksima koji su u polju pohranjeni kao ushort
	// i krećemo od offseta 0 (od početka polja) indeksa
